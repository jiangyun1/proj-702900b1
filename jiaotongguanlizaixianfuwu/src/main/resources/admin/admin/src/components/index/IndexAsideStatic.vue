<template>
  <!-- <el-aside height="100vh" width="210px"> -->
    <div  style="height:100vh;background-color: #5E5B5B;" >
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#5E5B5B">
        ...
        <el-menu  :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#5E5B5B" text-color="#ffffff" active-text-color="#1772F6" default-active="0">
